...
Replace the username and repository name as appropriate. By default, `git clone` will place the clone repo into your current command line/terminal directory. You can change this by specifying a filepath after the repo name in the clone command, like so:
